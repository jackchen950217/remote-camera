 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const hN=en("XCircle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]]);let Yh,ut="default-app-id";typeof __firebase_config<"u"?(Yh=JSON.parse(__firebase_config),typeof __app_id<"u"&&(ut=__app_id)):(Yh={apiKey:"AIzaSyCRoAh0dtSAs5BIDyaBkOousivW-WAEHhk",authDomain:"remotecamera-47707.firebaseapp.com",projectId:"remotecamera-47707",storageBucket:"remotecamera-47707.firebasestorage.app",messagingSenderId:"608671743750",appId:"1:608671743750:web:663afaed75cd1a65cf6887",measurementId:"G-BZBHTH4BSW"},ut="my-remote-camera-app");const hE=s0(Yh),xc=tP(hE),wt=Bx(hE),dE={iceServers:[{urls:"stun:stun.l.google.com:19302"},{urls:["turn:global.relay.metered.ca:80","turn:global.relay.metered.ca:80?transport=tcp","turn:global.relay.metered.ca:443","turn:global.relay.metered.ca:443?transport=tcp"],username:"8578b27b2c9e1c66e9bdf656",credential:"d3PMiwK+HSKTgVzp"}],iceCandidatePoolSize:10};function dN(){const[t,e]=U.useState(null);return U.useEffect(()=>{(async()=>{typeof __initial_auth_token<"u"&&__initial_auth_token?await BC(xc,__initial_auth_token):await MC(xc)})(),WC(xc,e)},[]),t?j.jsx(yA,{children:j.jsxs(cA,{children:[j.jsx(ja,{path:"/",element:j.jsx(fN,{})}),j.jsx(ja,{path:"/camera",element:j.jsx(pN,{})}),j.jsx(ja,{path:"/viewer",element:j.jsx(mN,{})})]})}):j.jsxs("div",{className:"flex items-center justify-center h-screen bg-gray-900 text-white",children:[j.jsx("div",{className:"animate-spin mr-2",children:j.jsx(lN,{})})," 連線伺服器中..."]})}function fN(){return j.jsxs("div",{className:"min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6 space-y-8 animate-fade-in",children:[j.jsx("h1",{className:"text-4xl font-bold text-blue-400 mb-8 text-center",children:"遠端監控系統"}),j.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl",children:[j.jsx(lg,{to:"/camera",className:"group text-decoration-none",children:j.jsxs("div",{className:"bg-gray-800 hover:bg-gray-700 border-2 border-blue-500/30 hover:border-blue-500 p-8 rounded-2xl flex flex-col items-center transition-all transform hover:-translate-y-1 shadow-xl cursor-pointer h-full",children:[j.jsx("div",{className:"bg-blue-900/30 p-4 rounded-full mb-4 group-hover:bg-blue-900/50 transition-colors",children:j.jsx(sN,{size:64,className:"text-blue-400"})}),j.jsx("span",{className:"text-2xl font-bold mb-2 text-white",children:"我是相機端"}),j.jsxs("span",{className:"text-gray-400 text-sm text-center",children:["安裝在舊手機上",j.jsx("br",{}),"(提供影像)"]})]})}),j.jsx(lg,{to:"/viewer",className:"group text-decoration-none",children:j.jsxs("div",{className:"bg-gray-800 hover:bg-gray-700 border-2 border-emerald-500/30 hover:border-emerald-500 p-8 rounded-2xl flex flex-col items-center transition-all transform hover:-translate-y-1 shadow-xl cursor-pointer h-full",children:[j.jsx("div",{className:"bg-emerald-900/30 p-4 rounded-full mb-4 group-hover:bg-emerald-900/50 transition-colors",children:j.jsx(cE,{size:64,className:"text-emerald-400"})}),j.jsx("span",{className:"text-2xl font-bold mb-2 text-white",children:"我是監控端"}),j.jsxs("span",{className:"text-gray-400 text-sm text-center",children:["使用電腦或新手機",j.jsx("br",{}),"(觀看影像)"]})]})})]}),j.jsx("div",{className:"mt-8 text-xs text-gray-600",children:"v2.9 - Race Condition Fixed"})]})}function pN(){const[t,e]=U.useState(""),[n,r]=U.useState("初始化中..."),[i,s]=U.useState(!1),o=U.useRef(!1),l=Gd(),u=U.useRef(null),h=U.useRef(null),f=U.useRef(null),p=U.useRef([]);U.useEffect(()=>{o.current=i},[i]),U.useEffect(()=>{let P=localStorage.getItem("my_camera_room_id");P||(P=Math.random().toString(36).substring(2,8).toUpperCase(),localStorage.setItem("my_camera_room_id",P)),e(P),r("待機中 - 等待監控端連線...");const v=Dr(wt,"artifacts",ut,"public","data","camera_rooms",P);aE(v,{status:"waiting",offer:null,answer:null,lastUpdated:new Date});const _=$s(v,T=>{const D=T.data();D&&(D.status==="requested"&&!o.current&&A(P),D.status==="ended"&&C())});return()=>{_(),C()}},[]);const m=async P=>{try{const v=eN(wt),_=Iy(_i(wt,"artifacts",ut,"public","data",`candidates_caller_${P}`));(await Ry(_)).forEach(b=>v.delete(b.ref));const D=Iy(_i(wt,"artifacts",ut,"public","data",`candidates_callee_${P}`));(await Ry(D)).forEach(b=>v.delete(b.ref)),await v.commit()}catch(v){console.error("清理數據失敗:",v)}},A=async P=>{if(!o.current){o.current=!0,s(!0);try{r("正在清理舊連線數據..."),await m(P),r("收到連線請求，啟動相機...");const v=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1280},height:{ideal:720},frameRate:{ideal:15}},audio:!1});u.current=v,f.current&&(f.current.srcObject=v);const _=new RTCPeerConnection(dE);h.current=_,_.oniceconnectionstatechange=()=>{console.log("ICE State:",_.iceConnectionState),["failed","closed"].includes(_.iceConnectionState)&&(r("連線中斷，停止傳輸"),C())},v.getTracks().forEach(w=>_.addTrack(w,v));const T=_i(wt,"artifacts",ut,"public","data",`candidates_caller_${P}`);_.onicecandidate=w=>{w.candidate&&lE(T,w.candidate.toJSON())};const D=await _.createOffer();await _.setLocalDescription(D);const L=Dr(wt,"artifacts",ut,"public","data","camera_rooms",P);await Ul(L,{offer:{type:D.type,sdp:D.sdp},status:"offering"});const b=$s(L,w=>{const I=w.data();if(!_.currentRemoteDescription&&(I!=null&&I.answer)){const R=new RTCSessionDescription(I.answer);_.setRemoteDescription(R),r("監控端已連線，正在傳輸影像")}});p.current.push(b);const E=_i(wt,"artifacts",ut,"public","data",`candidates_callee_${P}`),y=$s(E,w=>{w.docChanges().forEach(async I=>{if(I.type==="added")try{await _.addIceCandidate(new RTCIceCandidate(I.doc.data()))}catch{}})});p.current.push(y)}catch(v){console.error(v),r("相機啟動失敗: "+v.message),o.current=!1,s(!1)}}},C=async()=>{if(r("待機中 - 省流模式啟動"),o.current=!1,s(!1),p.current.forEach(P=>P()),p.current=[],f.current&&(f.current.srcObject=null),u.current&&(u.current.getTracks().forEach(P=>P.stop()),u.current=null),h.current&&(h.current.close(),h.current=null),t){const P=Dr(wt,"artifacts",ut,"public","data","camera_rooms",t);try{const v=await Jx(P);if(v.exists()&&v.data().status==="requested"){console.log("偵測到新的連線請求，跳過重置為 waiting");return}await Ul(P,{status:"waiting",offer:null,answer:null})}catch{}}},N=()=>{const P=document.createElement("textarea");P.value=t,P.style.position="fixed",P.style.left="-9999px",document.body.appendChild(P),P.focus(),P.select();try{const v=document.execCommand("copy");alert(v?"ID 已複製":"複製失敗")}catch{alert("複製失敗，請手動選取")}document.body.removeChild(P)};return j.jsxs("div",{className:"flex flex-col h-screen bg-black text-white",children:[j.jsxs("div",{className:"bg-gray-900 p-4 border-b border-gray-800 flex justify-between items-center shadow-lg z-10",children:[j.jsxs("div",{children:[j.jsx("div",{className:"text-gray-400 text-sm uppercase tracking-wider mb-1",children:"本機固定 ID"}),j.jsxs("div",{className:"text-6xl font-mono text-blue-400 font-bold flex items-center gap-3",children:[t,j.jsx("button",{onClick:N,className:"bg-gray-800 p-3 rounded hover:bg-gray-700 text-white",children:j.jsx(oN,{size:24})})]})]}),j.jsxs("div",{className:"flex flex-col items-end gap-2",children:[j.jsx("button",{onClick:()=>l("/"),className:"text-xs bg-gray-800 px-2 py-1 rounded text-gray-400",children:"Back"}),j.jsxs("div",{className:`flex items-center gap-2 px-3 py-1 rounded-full text-sm font-bold transition-all ${i?"bg-red-900/80 text-red-200 animate-pulse":"bg-green-900/80 text-green-200"}`,children:[i?j.jsx(cN,{size:16}):j.jsx(uN,{size:16}),i?"傳輸中":"省流待機"]})]})]}),j.jsxs("div",{className:"flex-1 relative flex items-center justify-center overflow-hidden bg-gray-900",children:[i?j.jsx("video",{ref:f,autoPlay:!0,playsInline:!0,muted:!0,className:"w-full h-full object-contain"}):j.jsxs("div",{className:"text-center p-8 opacity-60",children:[j.jsx(aN,{size:100,className:"mx-auto mb-6 text-gray-700"}),j.jsx("h3",{className:"text-2xl font-bold text-gray-300",children:"休眠中"}),j.jsxs("p",{className:"text-gray-500 mt-2",children:["請在監控端輸入 ID 連線",j.jsx("br",{}),"鏡頭將自動喚醒"]})]}),j.jsx("div",{className:"absolute bottom-8 left-0 right-0 flex justify-center",children:j.jsx("span",{className:"bg-black/70 px-6 py-2 rounded-full text-sm text-gray-300 backdrop-blur-md border border-gray-700 shadow-xl",children:n})})]})]})}function mN(){const[t,e]=U.useState(""),[n,r]=U.useState(!1),[i,s]=U.useState("準備就緒"),[o,l]=U.useState(0),[u,h]=U.useState(0),f=Gd(),p=U.useRef(null),m=U.useRef(null),A=U.useRef(null),C=U.useRef(null),N=U.useRef([]);U.useEffect(()=>{const T=localStorage.getItem("last_viewer_room_id");T&&e(T)},[]),U.useEffect(()=>{if(n){let T=0;C.current=setInterval(async()=>{if(m.current)try{const D=await m.current.getStats();let L=0;if(D.forEach(b=>{b.type==="inbound-rtp"&&(b.kind==="video"||b.kind==="audio")&&(L+=b.bytesReceived||0)}),h((L/1024/1024).toFixed(2)),T>0){const b=L-T;b>=0&&l((b/1024).toFixed(1))}T=L}catch(D){console.log("Stats error",D)}},1e3)}return()=>{C.current&&clearInterval(C.current)}},[n]);const P=async()=>{if(!t)return;const T=t.trim().toUpperCase();localStorage.setItem("last_viewer_room_id",T),A.current=T,r(!0),s("正在喚醒相機端..."),l(0),h(0);const D=Dr(wt,"artifacts",ut,"public","data","camera_rooms",T);await aE(D,{status:"requested"},{merge:!0});const L=$s(D,async b=>{const E=b.data();(E==null?void 0:E.status)==="offering"&&(E!=null&&E.offer)&&!m.current&&(s("建立加密連線中..."),await v(E.offer,T))});N.current.push(L)},v=async(T,D)=>{const L=new RTCPeerConnection(dE);m.current=L,L.ontrack=R=>{p.current&&(p.current.srcObject=R.streams[0],p.current.play().catch(k=>console.log("AutoPlay failed",k)),s("影像接收中"))},L.oniceconnectionstatechange=()=>{["failed","closed"].includes(L.iceConnectionState)&&s("連線中斷")};const b=_i(wt,"artifacts",ut,"public","data",`candidates_callee_${D}`);L.onicecandidate=R=>{R.candidate&&lE(b,R.candidate.toJSON())},await L.setRemoteDescription(new RTCSessionDescription(T));const E=await L.createAnswer();await L.setLocalDescription(E);const y=Dr(wt,"artifacts",ut,"public","data","camera_rooms",D);await Ul(y,{answer:{type:E.type,sdp:E.sdp},status:"connected"});const w=_i(wt,"artifacts",ut,"public","data",`candidates_caller_${D}`),I=$s(w,R=>{R.docChanges().forEach(async k=>{if(k.type==="added")try{await L.addIceCandidate(new RTCIceCandidate(k.doc.data()))}catch{}})});N.current.push(I)},_=()=>{if(N.current.forEach(T=>T()),N.current=[],m.current&&(m.current.close(),m.current=null),p.current&&(p.current.srcObject=null),A.current){const T=Dr(wt,"artifacts",ut,"public","data","camera_rooms",A.current);Ul(T,{status:"ended"}).catch(D=>{})}r(!1)};return n?j.jsxs("div",{className:"flex flex-col h-screen bg-black",children:[j.jsxs("div",{className:"bg-gray-900/90 backdrop-blur-md p-3 flex justify-between items-center px-4 border-b border-gray-800 absolute top-0 left-0 right-0 z-10",children:[j.jsxs("div",{className:"flex items-center gap-4",children:[j.jsxs("div",{className:"flex flex-col",children:[j.jsx("span",{className:"text-[10px] text-gray-400 uppercase",children:"Status"}),j.jsxs("div",{className:"flex items-center gap-1 text-sm font-bold text-white",children:[j.jsx("div",{className:`w-2 h-2 rounded-full ${i==="影像接收中"?"bg-green-500":"bg-yellow-500 animate-pulse"}`}),i==="影像接收中"?"LIVE":"Connecting..."]})]}),j.jsxs("div",{className:"flex items-center gap-4 bg-black/40 px-3 py-1 rounded-lg border border-gray-700",children:[j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsx(rN,{size:14,className:"text-blue-400"}),j.jsxs("div",{children:[j.jsx("span",{className:"text-[10px] text-gray-400 block",children:"Speed"}),j.jsxs("span",{className:"text-sm font-mono font-bold text-blue-200",children:[o," ",j.jsx("span",{className:"text-xs text-blue-500",children:"KB/s"})]})]})]}),j.jsx("div",{className:"w-[1px] h-6 bg-gray-700"}),j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsx(iN,{size:14,className:"text-purple-400"}),j.jsxs("div",{children:[j.jsx("span",{className:"text-[10px] text-gray-400 block",children:"Total"}),j.jsxs("span",{className:"text-sm font-mono font-bold text-purple-200",children:[u," ",j.jsx("span",{className:"text-xs text-purple-500",children:"MB"})]})]})]})]})]}),j.jsxs("button",{onClick:_,className:"bg-red-900/80 text-red-100 px-4 py-2 rounded-lg text-sm font-bold hover:bg-red-800 flex items-center gap-2",children:[j.jsx(hN,{size:16})," 斷線"]})]}),j.jsx("div",{className:"flex-1 relative flex items-center justify-center pt-16 pb-4",children:j.jsx("video",{ref:p,autoPlay:!0,playsInline:!0,controls:!0,className:"w-full h-full object-contain"})})]}):j.jsxs("div",{className:"flex flex-col items-center justify-center h-screen bg-gray-900 p-6 animate-fade-in text-gray-100 relative",children:[j.jsx("button",{onClick:()=>f("/"),className:"absolute top-4 left-4 text-gray-400 hover:text-white",children:"← Back Home"}),j.jsxs("div",{className:"bg-gray-800 p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-700",children:[j.jsxs("h2",{className:"text-2xl font-bold mb-6 text-center text-emerald-400 flex items-center justify-center gap-2",children:[j.jsx(cE,{})," 遠端監控台"]}),j.jsxs("div",{className:"mb-6",children:[j.jsx("label",{className:"text-gray-400 text-sm mb-2 block",children:"請輸入相機端 ID"}),j.jsx("input",{type:"text",placeholder:"例如: X7Y9Z1",value:t,onChange:T=>e(T.target.value.toUpperCase()),className:"w-full bg-gray-900 border border-gray-600 rounded-lg px-4 py-3 text-white text-center text-2xl tracking-widest font-mono focus:ring-2 focus:ring-emerald-500 outline-none uppercase"})]}),j.jsx("button",{onClick:P,disabled:!t,className:"w-full bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-700 disabled:text-gray-500 text-white py-4 rounded-lg font-bold text-lg transition-colors shadow-lg",children:"喚醒並連線"})]})]})}Nc.createRoot(document.getElementById("root")).render(j.jsx(by.StrictMode,{children:j.jsx(dN,{})}));
